...
class EditStoryModal(SigninPage):
    ...
    def enter_new_bullet_text(self, ctx: Context, text: str) -> None:
        ClickFunctions.click_element_by_name(ctx, self.locators, "custom_text_input")
        InputFunctions.send_keys_to_element_by_name(ctx, self.locators, "custom_text_input", text)
